...
const ConnectButton = () => {
  ...
  if (account) {
    return <button className="border-2  border-theme-yellow text-md px-2 rounded-sm bg-theme-gray hover:bg-theme-yellow/20 justify-center text-center inline-flex mx-auto" onClick={() => {
      deactivate()
      location.reload()
    }}>Disconnect</button>;
  } else {
